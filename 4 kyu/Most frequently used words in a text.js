...
function topThreeWords(text) {
  ...
  if (wordCount.length < 3) {
    wordCountLen = wordCount.length;
  }

  for (let idx = 0; idx < wordCountLen; idx++) {
    mostCommonWords.push(wordCount[idx][0]);
  }
